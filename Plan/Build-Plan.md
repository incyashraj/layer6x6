...
| 3 | UI + Graphics | Started | 2026-05-19 | pending | Phase 3 has begun at the contract layer: draft GUI WIT, GUI manifest recognition, first `ui`/`gfx`/`audio` capability names, and a shared in-memory UI adapter model are in place. |
