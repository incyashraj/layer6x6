...
|------|--------------|--------------|
| Core Phase 2 engineering | About 88-90% through the first useful CLI slice | WIT freeze review, more shared adapter slices, cross-host identity runs, and network hardening. |
