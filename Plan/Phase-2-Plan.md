...
| 5 | TypeScript (jco) bindings generated and usable; sample builds and runs | Started: `layer36 doctor` now reports Node, npm, and jco readiness; SDK package and sample build remain |
