...
|------|--------------|--------------|
| Core Phase 2 engineering | About 77-82% through the first useful CLI slice | WIT freeze review, more shared adapter slices, cross-host identity runs, and network hardening. |
