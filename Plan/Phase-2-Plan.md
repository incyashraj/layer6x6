...
| P2-RSRC-02 | Resource ID reuse in local and host tables | 2026-05-05 | Local adapter and generated host resource tables now reuse released file/stream IDs before allocating new IDs. Added runtime tests for close/drop reuse paths so long-running sessions do not consume unbounded resource IDs. |
