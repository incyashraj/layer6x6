...
| P2-CI-31 | Final review bundle shortcut | 2026-05-18 | Added `scripts/record-phase2-exit-bundle.sh --final-review` as shorthand for strict mode plus Rust SDK, hosted CI stability, and self-hosted full-gate evidence. This gives final Phase 2 review one command for the fuller local packet while still keeping the default quick bundle cheap. |
