...
| **Host Adapter** | The per-OS module inside the Layer36 runtime that maps UAPI calls to native OS calls. |
| **JIT** | Just-In-Time compilation. |
| **Manifest** | `manifest.toml` — describes a Layer36 app's metadata and required capabilities. |
| **Layer36** | The universal application platform described here. |
